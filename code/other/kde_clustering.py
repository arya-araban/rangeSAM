...
def main(file_path='point_cloud.ply', output_file_path=None, visualize=False, bandwidth=1.0, grid_size=100):
...
if __name__ == "__main__":
    ...
    file_path = '/home/Arya/Work/PointSAM/code/CARLA Scripts/recordings/1716903731/frame_000269_segments/point_cloud_107_142_35.ply'
    output_file_path = 'centroids_visualization.ply'
    visualize = True
    bandwidth = 3.0
    grid_size = 50

    main(file_path, output_file_path, visualize, bandwidth, grid_size)
